...
fn main() {
    ...
    println!("{}", ncd_vitanyi("compressme", "scompressme", "5"));
    println!("{}", ncd_cons("compressme", "scompressme", "5"));
    println!("{}", ncd_sym_cons("compressme", "scompressme", "5"));
    println!("{}", ncd_sym_vitanyi("compressme", "scompressme", "5"));
