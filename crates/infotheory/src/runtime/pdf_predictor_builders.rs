...
pub(super) fn build_pdf_predictor_match(
    ...
    anyhow::bail!(
        "{}",
        registry::rate_backend_feature_error(RateBackendKind::Match)
    )
}
...
pub(super) fn build_pdf_predictor_sparse_match(
    ...
    anyhow::bail!(
        "{}",
        registry::rate_backend_feature_error(RateBackendKind::SparseMatch)
    )
}
...
pub(super) fn build_pdf_predictor_ppmd(
    ...
    anyhow::bail!(
        "{}",
        registry::rate_backend_feature_error(RateBackendKind::Ppmd)
    )
}
...
pub(super) fn build_pdf_predictor_sequitur(
    ...
    anyhow::bail!(
        "{}",
        registry::rate_backend_feature_error(RateBackendKind::Sequitur)
    )
}
...
pub(super) fn build_pdf_predictor_calibrated(
    ...
    anyhow::bail!(
        "{}",
        registry::rate_backend_feature_error(RateBackendKind::Calibrated)
    )
}
